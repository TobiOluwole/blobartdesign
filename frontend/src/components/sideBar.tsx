        ...
        return (
            <>
                ...
                <aside className={
                    ...
                    <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                        ...
                        <ul className="space-y-2 font-medium">
                            ...
                            {/*                d="M12.5 0c-.157 0-.311.01-.565.027A1 1 0 0 0 11 1.02V10h8.975a1 1 0 0 0 1-.935c.013-.188.028-.374.028-.565A8.51 8.51 0 0 0 12.5 0Z"/>*/}
                            {/*        </svg>*/}
                            {/*        <span className="ms-3">Header</span>*/}
                            {/*    </Link>*/}
                            {/*</li>*/}
                            <li>
                                <Link href="/admin/socials"
                                      className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white group ${pathName == '/admin/socials' ? ' bg-gray-100 dark:bg-gray-700' : ' hover:bg-gray-100 dark:hover:bg-gray-700'}`}>
                                    <svg
                                        className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                        viewBox="0 0 22 21">
                                    ...
                                    <span className="ms-3">Socials</span>
                                </Link>
                            </li>
                            <li>
                ...
                <div className="p-4 sm:ml-64 h-screen">
                    <div className="p-4 h-full border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 overflow-y-auto">
                        <Component {...props} />
                    </div>
                </div>

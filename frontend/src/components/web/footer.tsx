                ...
                <div className="grid md:grid-cols-3 grid-cols-1 mt-6">
                    <div className="mb-8">
                        <div className="">
                            ...
                            <p><a href="tel:+(90) 542 889 19 05">+(90) 542 889 19 05</a></p>
                        </div>
                    </div>
                    <div className="mb-8">
                        <div className="">
                            ...
                            <p><a href="mailto:info@blobartdesign.com">info@blobartdesign.com</a></p>
                        </div>
                    </div>
                    <div className="mb-8">
                        <div className="">
                            ...
                            <p><a target="_blank" href="https://goo.gl/maps/zugKrxxBVvr7nmab9"> 5 Meşe Sokak, Küçük
                                Kaymaklı
                                Lefkoşa </a></p>
                        </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 grid-cols-1">
                        <div className="pt-8">
                            <div className="text-sm">
                                <p className="mt-3">Copyright @ 2024 BLOB</p>
                            </div>
                        </div>
                        <div className="py-8 flex items-center w-full">
                            <div className="flex self-center md:m-auto">
                                <Link target="_blank" href="https://www.facebook.com/profile.php?id=100064944105122" className="grid place-content-center border rounded-full text-[#777] mr-2 p-3">
                                ...
                                <Link target="_blank" href="#" className="grid place-content-center border rounded-full text-[#777] mr-2 p-3">
                                    <svg  viewBox="0 0 17 17" className="h-3 w-3 m-auto">
                                        <path
                                ...
                                <Link target="_blank" href="https://www.instagram.com/blobartdesign/" className="grid place-content-center border rounded-full text-[#777] mr-2 p-3">

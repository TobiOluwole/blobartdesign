    ...
    return (
        <>
            <div className="relative h-screen w-full p-0 m-0">
                <div
                    className={`absolute top-[50%] right-[12%] z-40 text-white  p-2 rounded transition-all ease-in-out w-[30vw] text-5xl text duration-500 ${textAnimation}`}
                >
                    <span className="float-end text-right tracking-headerWide -translate-y-2/4">{altText}</span>
                </div>

                <div className="absolute z-50 bottom-[2%] left-[12%] flex">
                    <div className="prevCarBut cursor-pointer p-3  rounded-full border-white border m-1 my-3">
                    ...
                    <div className="nextCarBut cursor-pointer p-3 rounded-full border-white border m-1 my-3">
                        <svg version="1.1" viewBox="0 0 17 17" className="fill-white h-3.5 w-3.5 ">
                            <path
                ...
                >
                    <SwiperSlide>
                        <img className="min-h-screen min-w-full brightness-[.3] object-cover" src="/img/slides/1-2---foto--1-.jpg"
                             alt="BANKA SHOWROOM VE KONUT PROJELERİ"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <img className="min-h-screen min-w-full brightness-[.3] object-cover" src="/img/slides/42--2-.jpg"
                             alt="FİLM STÜDYOSU PROJELERİ"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <img className="min-h-screen min-w-full brightness-[.3] object-cover"
                             src="/img/slides/02082022-ozmerter-08--2-.jpg" alt="KONUT PROJELERİ"/>
                    </SwiperSlide>
                    <SwiperSlide>
                        <img className="min-h-screen min-w-full brightness-[.3] object-cover"
                             src="/img/slides/dagli-photo---3--1-.jpg"
                             alt="MERKEZ OFİS VE KONUT PROJELERİ"/>
                    </SwiperSlide>
                </Swiper>
                ...
                <div className="left-panel">
                    <ul className="social-left clearfix" >
                        ...
                        <li>
                            <Link href="https://www.instagram.com/blobartdesign/" className="grid place-content-center">
                        ...
                        <li>
                            <Link href="https://www.facebook.com/profile.php?id=100064944105122" className="grid place-content-center">
                                <svg viewBox="0 0 17 17" className="h-4 w-4 m-auto">
                                    <path
